...
Slider.prototype.Move = function () {
    ...
    if (_self.index > 0) {
        ...
        if (_self.isMobile) {
            ...
            style = {
                "border-bottom-left-radius": "0px", "border-top-left-radius": "0px",
                "border-bottom-right-radius": "29px", "border-top-right-radius": "29px"
            };
        }
    ...
    var num; //30  62
    if (_self.isMobile) { num = 28; } else { num = 62; }
    ...
    if (_self.index < 0) {
        ...
        if (_self.isMobile) {
            ...
            var style = {
                "border-bottom-left-radius": "28px", "border-top-left-radius": "28px",
                "border-bottom-right-radius": "0px", "border-top-right-radius": "0px"
            };
        }
        $(".slider.left").css(style);
